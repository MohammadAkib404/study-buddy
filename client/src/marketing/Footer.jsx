...
function Footer() {
  return (
    <footer className="text- bg-bg md:text-md xl:text-xl bg-light text-primary px-8 py-12 border-t border-border">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="leading-relaxed mb-4 max-w-md">The easiest app to revise concepts, break down complexity, and learn faster.</p>
