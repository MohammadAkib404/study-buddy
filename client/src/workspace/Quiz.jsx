...
function Quiz() {
  ...
  const data = location.state || dummyData;
    ...
    <section className="sm:p-5">
      ...
      <div className="sm:border-1 rounded-2xl max-w-3xl px-6 sm:px-8 py-10 m-auto">
        ...
        <div className="flex flex-col">
          <h4 className="text-lg sm:text-2xl font-bold my-8">
          ...
          <div className="w-full flex justify-end ">
            <button onClick={changeQuestion} className="bg-brand text-text font-semibold px-6 py-3 rounded-lg ">
              Next
            </button>
          </div>
        </div>
